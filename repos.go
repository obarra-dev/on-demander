...
func getRepos() []string {
	return []string{
		...
		`{"host":"github.com","repoOwner":"obarra-dev","repoName":"BIper","branch":"main","generatePrToFixIssues":false}`,

		`{"host":"github.com","repoOwner":"obarra-dev","repoName":"dependency-track","branch":"main","generatePrToFixIssues":false}`,
		`{"host":"github.com","repoOwner":"obarra-dev","repoName":"dependency-track","branch":"source2","generatePrToFixIssues":false}`,

		`{"host":"github.com","repoOwner":"obarra-dev","repoName":"forecast-service","branch":"main","generatePrToFixIssues":false}`,
